...
<table class="table table-dark table-striped">
  <thead >
    <tr>
      ...
      <th scope="col">Doxumento</th>
      <th scope="col">Cpntraseña</th>
  ...
  <tbody>
    ...
    if ($sql) {
        while ($datos = $sql->fetch_object()) {
            ...
            echo "<td><a href='../controller/delete.php?id=" . $datos->id_usuario ."'><i class='fa-solid fa-trash'></i></a>";
            echo "<td><a href='updateUser.php?id=" . $datos->id_usuario . "'><i class='fa-solid fa-user-pen'></i></a></td>";
